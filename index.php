...
<div id="main-content">
    ...
    <?php
        ...
        $sql = "SELECT * FROM student JOIN studentclass WHERE student.sclass = studentclass.cid"; //write query
    ...
    <table cellpadding="7px">
        ...
        <tbody>
            ...
            <?php 
                while($row = mysqli_fetch_assoc($result)){ //query run kore data niea asa
            ?>
            <tr>
